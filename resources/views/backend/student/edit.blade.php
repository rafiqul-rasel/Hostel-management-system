...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <a href="{{route('dashboard.student.index')}}" class="btn btn-primary float-right btn-sm" id="new_user"><i class="fa fa-plus"></i>All Student</a>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class=" col-lg-12">
            ...
            <div class="card-body">
                <form method="post" action="{{route('dashboard.student.update',$user->id)}}">
                    @csrf
                    @method('put')
                    <div class="mb-3 row">
