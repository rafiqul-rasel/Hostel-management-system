            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="row" style="margin-left: 30%;margin-top: 10%;"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h3 class="h4 text-gray-900 mb-4">Welcome to  DUET Hostel Management System!</h3>
                                    </div>
                                    ...
                                    <div class="text-center">
                                     <!--   <a class="small" href="register.html">একটি অ্যাকাউন্ট তৈরি করুন!</a> -->
                                    </div>
                                </div>
                            </div>
                        </div>
