                ...
                <div class="col-md-4">
                    <form method="post" action="{{route("dashboard.hall-apply.store")}}" id="manage-deductions">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if(isset($apply->status)==1 && !isset($apply->hall_id))
                                    <h6>Your Application Is Processing</h6>
                                @elseif(isset($apply->status)==1)
                                    <h6>Your Application Is Successfully Granted</h6>
                                @elseif(isset($apply->status)==2)
                                        <h6>Your Can't apply</h6>
                                @else
                        ...
                        <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>Hall</td>
                                    <td>{{get_nameFromHallId($apply->hall_id)}}</td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td>Room</td>
                                    <td>{{get_nameFromRoomId($apply->room_id)}}</td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td>Seat</td>
                                    <td>{{ get_nameFromSeatId($apply->seat_id)}}</td>
                                </tr>
                                @endif
                                </tbody>
                            </table>
