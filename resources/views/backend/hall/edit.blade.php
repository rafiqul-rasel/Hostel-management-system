    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="row">
                <!-- FORM Panel -->
                <div class="col-md-4">
                    <form method="post" action="{{route("dashboard.hall.update",$hall->id)}}" id="manage-deductions">
                        @csrf
                        @method('put')
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="hall"  id="" cols="30" rows="2" class="form-control" required="">{{$hall->name}}</textarea>
                                </div>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-12">
                                        <button class="btn btn-sm-5 btn-primary "> Update Hall</button>
